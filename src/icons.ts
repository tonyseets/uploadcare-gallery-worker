 ...
 * 
 * Returns inline SVG icons for different file types based on extension.
 */

import { isVideoExtension, isPdfExtension } from './files';

/**
 * Returns an inline SVG icon for the given file extension.
 * Uses stroke icons with currentColor for easy styling.
 */
export function getFileTypeIconSvg(ext: string): string {
